  ...
  return (
    <section id="inicio" className="pt-[70px]">
      <div className="grid lg:grid-cols-2 min-h-[580px] lg:min-h-[640px]">
        {/* Left: Text Content */}
        <div className="flex flex-col justify-center px-6 sm:px-10 lg:px-16 xl:px-20 py-14 lg:py-16 bg-white order-2 lg:order-1">
          <div className="max-w-xl">
            ...
            {/* Rating strip */}
            <div className="flex items-center gap-2 mt-8 pt-6 border-t border-brand-gray-mid">
      ...
      <div className="bg-brand-dark border-b-4 border-brand-red">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/10">
            {badges.map(({ icon: Icon, value, label }) => (
              <div key={value} className="flex items-center gap-3 px-4 sm:px-8 py-5">
